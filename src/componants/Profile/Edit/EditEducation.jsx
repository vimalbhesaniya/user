...
const EditEducation = () => {
    ...
    const handleSubmit = useCallback(async () => {
        ...
        const degreeLevel = degreeLevels ? degreeLevels?.split(",") : degreeLevels;
        const certifications = certificat ? certificat?.split(",") : certificat;
        const payload = {
    ...
    return (
        <div className="card container   w-100  bg-body-secondary cardContainer">
            ...
            <button className="btn btn-info w-25 mb-3" onClick={() => handleSubmit()}>Save</button>
        </div>
    );
}
