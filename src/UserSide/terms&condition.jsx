...
const Body = ({onClose}) => {
    return (
        <>
            <div class="container w-75  h-75  overflow-scroll  bg-body ">
                <div class="" >
                    <div class="modal-content p-3">
                        <div class="modal-header">
                            <h5 class="modal-title" id="termsModalLabel"></h5>
                                <span className='fs-1 hand' onClick={onClose}>&times;</span>         
                        </div>
                        <div class="modal-body  p-2">
                            <div class="container">
                                <div class="term-contant d-flex flex-column gap-2">
                                    <h1 class="underline-hover">Terms & Conditions</h1>
                                    <p>Welcome to JOB DUNIYA! These terms and conditions outline the rules and regulations for the use of our website.</p>
                                    <p>
                                        By accessing this website, we assume you accept these terms and conditions. Do not continue to use JOB DUNIYA if you do not
                                    ...
                                    <p>
                                        ...
                                        law of United States. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she
                                        or they, are taken as interchangeable and therefore as referring to same.
                                    </p>
                                </div>
                                <hr />

                                <h3 className='fs-3 mb-2'>Cookies</h3>
                                <p>
                                    We employ the use of cookies. By accessing JOB DUNIYA, you agreed to use cookies in agreement with the [Job Portal Name]'s
                                    Privacy Policy.
                                </p>
                                <hr />
                                <h3 className='fs-3 mb-2'mb-2>License</h3>
                                <p>
                                    Unless otherwise stated, JOB DUNIYA and/or its licensors own the intellectual property rights for all material on [Job Portal
                                    Name]. All intellectual property rights are reserved. You may access this from JOB DUNIYA for your own personal use subjected
                                ...
                                <ul>
                                    ...
                                    <li>Sell, rent or sub-license material from JOB DUNIYA</li>
                                    <li>Reproduce, duplicate or copy material from JOB DUNIYA</li>
                                    <li>Redistribute content from JOB DUNIYA</li>
                                </ul>
                                <hr />
                                <h3 className='fs-3 mb-2'>Comments</h3>
                                <p>
                                    ...
                                    website. JOB DUNIYA does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not
                                    reflect the views and opinions of JOB DUNIYA,its agents and/or affiliates. Comments reflect the views and opinions of the
                                    person who post their views and opinions. To the extent permitted by applicable laws, JOB DUNIYA shall not be liable for the
                                ...
                                <p>
                                    JOB DUNIYA reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
                                ...
                                <p>
                                    You hereby grant JOB DUNIYA a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit
                                    any of your Comments in any and all forms, formats or media.
                                </p>
                                <hr />
                                <h3 className='fs-3 mb-2'>Hyperlinking to our Content</h3>
                                ...
                                <p>
                                    ...
                                    us from the visibility of the hyperlink compensates the absence of JOB DUNIYA; and (d) the link is in the context of general
                                ...
                                <p>
                                    ...
                                    us by sending an e-mail to JOB DUNIYA. Please include your name, your organization name, contact information as well as the
                                ...
                                <p>No use of JOB DUNIYA's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                                <hr />
                                <h3 className='fs-3 mb-2'>iFrames</h3>
                                <p>
                                ...
                                <hr />
                                <h3 className='fs-3 mb-2'>Content Liability</h3>
                                <p>
                                    We shall not be held responsible for any content that appears on your Website. You agree to protect and defend us against all
                                ...
                                <hr />
                                <h3 className='fs-3 mb-2'>Reservation of Rights</h3>
                                <p>
                                ...
                                <hr />
                                <h3 className='fs-3 mb-2'>Removal of links from our website</h3>
                                <p>
                                ...
                                <hr />
                                <h3 className='fs-3 mb-2'>Disclaimer</h3>
                                <p>
